...
def deposit_eth(request, account):
    return render(request, 'deposit_eth.html')

def deposit_usdt(request):
    return render(request, 'deposit_usdt.html')

def deposit_usdc(request):
    return render(request, 'deposit_usdc.html')
